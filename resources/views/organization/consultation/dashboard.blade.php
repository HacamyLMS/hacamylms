...
@section('content')
                ...
                <form action="{{ route('organization.consultation.availabilityUpdate') }}" method="post">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($organization->consultation_available == 1) checked @endif type="radio"
                                id="inlineCheckbox1" value="1" name="consultation_available">
                            <label class="form-check-label color-heading mb-0"
                                for="inlineCheckbox1">{{ __('Yes') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($organization->consultation_available != 1) checked @endif type="radio"
                                id="inlineCheckbox2" value="0" name="consultation_available">
                            <label class="form-check-label color-heading mb-0"
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($organization->available_type == 1) checked @endif type="radio"
                                id="inlineCheckbox3" value="1" name="available_type">
                            <label class="form-check-label color-heading mb-0"
                                for="inlineCheckbox3">{{ __('In Person') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($organization->available_type == 2) checked @endif type="radio"
                                id="inlineCheckbox4" value="2" name="available_type">
                            <label class="form-check-label color-heading mb-0"
                                for="inlineCheckbox4">{{ __('Online') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($organization->available_type == 3) checked @endif type="radio"
                                id="inlineCheckbox5" value="3" name="available_type">
                            <label class="form-check-label color-heading mb-0"
                                for="inlineCheckbox5">{{ __('Both') }}</label>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row instructor-panel-hourly-rate-box align-items-center">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <input type="number" step="any" min="0" name="hourly_rate" class="form-control"
                                id="hourlyRate" placeholder="Ex.20" value="{{ $organization->hourly_rate }}">
                        </div>
                        @if ($errors->has('hourly_rate'))
                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i>
                                {{ $errors->first('hourly_rate') }}</span>
                        @endif
                    </div>
                    <div class="mb-3 row instructor-panel-hourly-rate-box align-items-center">
                        ...
                        @if ($errors->has('hourly_old_rate'))
                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i>
                                {{ $errors->first('hourly_old_rate') }}</span>
                        @endif
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('organization.consultation.slotStore') }}" method="post">
                        @csrf
                        <div class="add-slot-daywise-wrap">
                            <label
                                class="label-text-title color-heading font-medium font-20 mb-2">{{ __('Time') }}</label>
                                ...
                                <div class="d-flex">
                                    <div class="col-sm-5 col-md-5">
                                        <div class="input-group add-slot-day-item mb-3">
                                            <input type="time" class="form-control" name="starTimes[]"
                                                placeholder="Ex. 9:00 AM" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-5 col-md-5 ms-2">
                                        <div class="input-group add-slot-day-item mb-3">
                                            <input type="time" class="form-control" name="endTimes[]"
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-between">
                                    <button type="button"
                                        class="theme-btn theme-button1 default-btn green-theme-btn add_button">
    ...
    <div class="modal fade" id="viewSlotModal" data-bs-backdrop="static" tabindex="-1"
        aria-labelledby="viewSlotModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
