    ...
    <nav class="account-page-menu">
        <ul>
            ...
            <li class="menu-has-children current-menu-item {{@$navInstructorActiveClass}}">
                ...
                <a href="#" class="{{@$navInstructorActiveClass}}"><span class="iconify mr-15" data-icon="mdi:teacher"></span>{{ __('Manage Tutors') }}</a>
                <ul class="account-sub-menu">
                    <li><a href="{{ route('organization.instructor.index') }}" class="{{@$subNavInstructorIndexActiveClass}}">{{ __('All Tutors') }}</a></li>
                    <li><a href="{{ route('organization.instructor.create') }}" class="{{@$subNavInstructorAddActiveClass}}">{{ __('Add Tutor') }}</a></li>
                </ul>
            </li>
            <li class="menu-has-children current-menu-item {{@$navStudentActiveClass}}">
                ...
                <a href="#" class="{{@$navStudentActiveClass}}"><span class="iconify mr-15" data-icon="ph:student"></span>{{ __('Manage Students') }}</a>
                <ul class="account-sub-menu">
                    <li><a href="{{ route('organization.student.index') }}" class="{{@$subNavStudentIndexActiveClass}}">{{ __('All Students') }}</a></li>
            ...
            <li class="menu-has-children current-menu-item {{@$navCourseActiveClass}}">
                ...
                <a href="#" class="{{@$navCourseActiveClass}}"><span class="iconify mr-15" data-icon="fluent:learning-app-20-regular"></span>{{ __('Manage Courses') }}</a>
                <ul class="account-sub-menu">
                    <li><a href="{{ route('organization.course.index') }}" class="{{@$subNavCourseIndexActiveClass}}">{{ __('All Courses') }}</a></li>
            ...
            <li class="d-none"><a href="{{route('organization.refund.index')}}" class="{{ @$navRefundActiveClass }}" ><span class="iconify mr-15" data-icon="gridicons:refund"></span>{{__('Refund List')}}</a></li>
            ...
            <li><a href="{{route('organization.finance.analysis.index')}}" class="{{ @$subNavAnalysisActiveClass }}" ><span class="iconify mr-15" data-icon="system-uicons:heart-rate"></span>{{__('Manage Payouts')}}</a></li>
