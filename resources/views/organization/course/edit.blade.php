                ...
                <div class="card">
                    <div id="msform">
                        ...
                        <ul id="progressbar"
                            ...
                            <li id="organization"><strong>{{ __('Tutors') }}</strong></li>
                        ...
                        <div class="upload-course-step-item upload-course-overview-step-item">
                            ...
                            <div id="upload-course-overview-1">
                                <form method="POST" action="{{route('organization.course.update.overview', [$course->uuid])}}"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select name="private_mode" id="private_mode" class="form-select"
                                                    ...
                                                    <option value="{{ COURSE_PRIVATE_ACTIVE }}"
                                                        {{old('private_mode', $course->private_mode)==COURSE_PRIVATE_ACTIVE ? 'selected' : '' }}>
                                                        {{ __("Enable") }}</option>
                                                    <option value="{{ COURSE_PRIVATE_DEACTIVATE }}"
                                                        {{old('private_mode', $course->private_mode)==COURSE_PRIVATE_DEACTIVATE ? 'selected' : '' }}>
                                                        {{ __("Disabled") }}</option>
                                                </select>
