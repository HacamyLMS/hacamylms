    ...
    <div class="page-banner-content text-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14"><a href="{{route('organization.resource.index', [$course->uuid])}}">{{__('Resource List') }}</a></li>
...
@section('content')
    <div class="instructor-profile-right-part">
        <div class="instructor-create-new-quiz-page instructor-create-assignment-page bg-white">
            ...
            <div class="row">
                <div class="col-12">
                    <form class="create-new-quiz-form" action="{{ route('organization.resource.store', $course->uuid) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-30">
                            <div class="col-md-12">
