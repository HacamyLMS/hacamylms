...
<body
  class="{{$selectedLanguage->rtl == 1 ? 'direction-rtl' : 'direction-ltr' }} {{get_option('app_color_design_type') == 2 ? 'custom-color' : '' }}">
  ...
  <button class="d-none pwa-install-btn bg-black position-fixed radius-4" id="installApp">
    <img src="{{ getImageFile(get_option('app_fav_icon')) }}" alt="Install icon" class="me-2"
      style="width: 20px; height: 20px;"><span class="iconify" style="color: #fff">Install Hacamy</span>
  </button>
