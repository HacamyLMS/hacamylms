...
<head>
    ...
    <link href="{{ asset('frontend/assets/css/style.css') }}?v={{env('VER', 1.2)}}" rel="stylesheet">
...
<body class="{{$selectedLanguage->rtl == 1 ? 'direction-rtl' : 'direction-ltr' }} {{get_option('app_color_design_type') == 2 ? 'custom-color' : '' }}">
...
<script
    src="{{asset('frontend/assets/vendor/datatable/datatables-responsive/js/dataTables.responsive.min.js')}}"></script>
<script
    src="{{asset('frontend/assets/vendor/datatable/datatables-responsive/js/responsive.bootstrap4.min.js')}}"></script>
