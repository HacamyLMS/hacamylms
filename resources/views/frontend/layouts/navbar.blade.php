      ...
      <div class="main-menu-collapse collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="dropdown-menu {{$selectedLanguage->rtl == 1 ? 'dropdown-menu-end' : ''}}">
                ...
                <li>
                  ...
                  <ul class="submenu dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="{{ route('subcategory-courses', $subcategory->slug) }}">{{
          ...
          <form action="#">
            <div class="input-group landing">
              ...
              <input class="form-control me-2 searchCourse" id="searchCourse" type="search" name="keyword"
                value="{{request('keyword')}}" placeholder="{{__('Search Course')}}..." aria-label="Search">
            </div>
        ...
        <div class="header-nav-right-side d-flex">
          <ul class="navbar-nav">
            ...
            @if(@$authUser->role == USER_ROLE_INSTRUCTOR || @$authUser->role == USER_ROLE_STUDENT || @$authUser->role ==
            ...
            <li class="nav-item dropdown menu-round-btn menu-user-btn dropdown-top-space">
              ...
              <div
                ...
                <ul class="user-dropdown-item-box">
                  ...
                  @if(Auth::user()->role == USER_ROLE_STUDENT || Auth::user()->is_affiliator == AFFILIATOR ||
                  (Auth::user()->role == USER_ROLE_INSTRUCTOR &&
