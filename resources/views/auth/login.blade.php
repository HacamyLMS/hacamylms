      ...
      <div class="col-md-12">
        <div class="sign-up-right-content" style="position: relative; overflow: hidden; opacity: 4.8;">
          ...
          <form method="POST" action="{{ route('login') }}"
            style="background-color: #fff; padding: 30px; border-radius: 10px;">
            <div class="sign-up-top-logo text-center">
              <a href="{{ route('main.index') }}"><img src="{{getImageFile(get_option('app_black_logo'))}}" alt="logo"
                  style="width: 200px;"></a>
            </div>
            @csrf

            <p class="font-14 mb-30 text-center">{{__('New User')}} ? <a href="{{route('sign-up')}}"
                class="color-hover text-decoration-underline font-medium">{{__('Create an Account')}}</a></p>
            ...
            <div class="row mb-20">
              <div class="col-md-12">
                ...
                <input type="text" name="email" value="{{old('email')}}" class="form-control email"
                  placeholder="{{ __('Type your email or phone number') }}" pattern="[^\s]+"
                  title="{{ __('Spaces are not allowed') }}" oninput="this.value=this.value.replace(/\s/g,'')" required>
                @if ($errors->has('email'))
              ...
              <div class="col-md-12">
                ...
                <div class="form-group mb-0 position-relative">
                  <input class="form-control password" name="password" value="{{old('password')}}"
                    placeholder="*********" type="password" pattern="[A-Za-z0-9]{8,}"
                    title="{{ __('Password must be at least 8 characters') }}" required>
            ...
            <div class="row mb-20">
              <div class="col-md-12"><a href="{{ route('forget-password') }}"
                  class="color-hover text-decoration-underline font-medium">{{__('Forgot Password')}}?</a></div>
            </div>
            <div class="row mb-2">
              <div class="col-md-12">
                <button type="submit"
                ...
                <table class="table table-bordered">
                  <tbody>
                    <tr>
                      ...
                      <td id="instructorCredentialShow" class="login-info"><b>Instructor:</b> instructor@gmail.com |
                        123456</td>
                    </tr>
                    <tr>
                      <td id="studentCredentialShow" class="login-info"><b>Student:</b> student@gmail.com | 123456</td>
                      <td id="affiliatorCredentialShow" class="login-info"><b>Affiliator:</b> affiliator@gmail.com |
                        123456</td>
                    </tr>
                    <tr>
                      <td colspan="2" id="organizationCredentialShow" class="login-info"><b>Organization:</b>
                        organization@gmail.com | 123456</td>
                    </tr>
                  </tbody>
                </table>
              </div>
