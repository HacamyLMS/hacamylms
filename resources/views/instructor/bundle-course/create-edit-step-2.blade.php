        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item font-14"><a
                        href="{{ route('instructor.dashboard') }}">{{ __('Dashboard') }}</a></li>
...
@section('content')
    ...
    <input type="hidden" class="addBundleCourseRoute" value="{{ route('instructor.bundle-course.addBundleCourse') }}">
    <input type="hidden" class="removeBundleCourseRoute" value="{{ route('instructor.bundle-course.removeBundleCourse') }}">
