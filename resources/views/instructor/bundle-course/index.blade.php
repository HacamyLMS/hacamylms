            ...
            <div class="row m-0 quiz-list-page-top mb-4">
                <div class="col-md-8">
                    <div class="quiz-list-page-top-left">
                        ...
                        <a href="{{ route('instructor.bundle-course.createStepOne') }}" class="create-new-quiz-btn font-medium">{{ __('Create Bundles Courses') }}</a>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                    <div class="card course-item border-0 radius-3 bg-white">
                        <div class="course-img-wrap overflow-hidden">
                            <a href="{{ route('instructor.bundle-course.editStepOne', $bundle->uuid) }}"><img src="{{ getImageFile($bundle->image) }}" alt="course" class="img-fluid"></a>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title course-title"><a href="{{ route('instructor.bundle-course.editStepOne', $bundle->uuid) }}">{{ $bundle->name }}</a></h5>
                            ...
                            <div class="instructor-my-courses-btns d-inline-flex ">
                                <a href="{{ route('instructor.bundle-course.editStepOne', $bundle->uuid) }}"
                                ...
                                <form action="{{route('instructor.bundle-course.delete', [$bundle->uuid])}}" method="post" id="delete_row_form_{{ $bundle->id }}">
                                    {{ method_field('DELETE') }}
