        ...
        <div class="instructor-quiz-list-page instructor-consultation-page">
            ...
            <div class="are-you-available-box mb-30">
                <form action="{{ route('instructor.consultation.instructorAvailabilityStoreUpdate') }}" method="post">
                    ...
                    <h6 class="are-you-available-title mb-3 d-inline-flex align-items-center"><span class="iconify me-2" data-icon="heroicons-outline:thumb-up"></span>{{ __('Chose your availability') }}</h6>
                    <div class="mb-3">
                        <div class="form-check form-check-inline">
                    ...
                    <div class="mb-3 row instructor-panel-hourly-rate-box align-items-center">
                        <label for="hourlyRate" class="col-sm-2 col-form-label font-medium color-heading">{{ __('Discount Hourly Rate') }} {{ get_currency_symbol() }}</label>
                    ...
                    <div class="mb-3 row instructor-panel-hourly-rate-box align-items-center">
                        <label for="hourlyOldRate" class="col-sm-2 col-form-label font-medium color-heading">{{ __('Standard Hourly Rate') }} {{ get_currency_symbol() }}</label>
                        <div class="col-sm-6 col-md-3">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch mb-3">
                            ...
                            <label class="form-check-label color-heading mb-0" for="offlineStatus">{{ __('Set Offline Status') }}</label>
                        </div>
