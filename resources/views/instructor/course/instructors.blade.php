                        ...
                        <form method="POST" action="{{route('course.store.instructor', [$course->uuid])}}"
                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                <div class="row">
                                    @php
                                    $instructors_id =
                                    @$course->course_instructors->where('status', STATUS_APPROVED)->pluck('instructor_id')->toArray();
                                    @endphp
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <table class="mt-3 table table-sm">
                                            ...
                                            <tbody id="instructor-parent">
                                                ...
                                                $oldShare = ($oldShare) ? $oldShare : @$course->course_instructors->where('status', STATUS_APPROVED)->where('instructor_id', $instructor->id)->first()->share;
                                                @endphp
