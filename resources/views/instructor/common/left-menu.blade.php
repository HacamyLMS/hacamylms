<div class="instructor-profile-left-part bg-white">
    <nav class="account-page-menu">
        <ul>
            ...
            <li><a href="{{route('instructor.course.create')}}" class="{{active_if_full_match('instructor/course/create')}} {{ @$navCourseUploadActiveClass }}"><span class="iconify mr-15" data-icon="feather:upload"></span>{{__('Upload New Course')}}</a></li>
            <li><a href="{{route('instructor.course')}}" class="{{active_if_full_match('instructor/course')}} {{ @$navCourseActiveClass }}" ><span class="iconify mr-15" data-icon="ion:log-in-outline"></span>{{__('Manage Courses')}}</a></li>
            ...
            <li><a href="{{ route('instructor.all-student') }}" class="{{ @$navAllStudentActiveClass }}"><span class="iconify mr-15" data-icon="ph:student"></span>{{__('Manage Students')}}</a></li>
            ...
            @endif
            <li class="d-none"><a href="{{route('instructor.refund.index')}}" class="{{ @$navRefundActiveClass }}" ><span class="iconify mr-15" data-icon="gridicons:refund"></span>{{__('Refund List')}}</a></li>
            ...
            <li><a href="{{route('discussion.index')}}" class="{{ @$navDiscussionActiveClass }}" ><span class="iconify mr-15" data-icon="octicon:comment-discussion-24"></span>{{__('Discussions')}}</a></li>
            <li><a href="{{route('instructor.chat.index')}}" class="{{ @$navChatActiveClass }}" ><span class="iconify mr-15" data-icon="ion-ios-chatboxes"></span>{{__('Chats')}}</a></li>
            <li><a href="{{route('finance.analysis.index')}}" class="{{ @$subNavAnalysisActiveClass }}" ><span class="iconify mr-15" data-icon="system-uicons:heart-rate"></span></span>{{__('Manage Payouts')}}</a></li>
            <li><a href="{{route('instructor.multi_instructor')}}" class="{{@$navInstructorRequestActiveClass}}" ><span class="iconify mr-15" data-icon="fluent:branch-request-20-regular"></span>{{__('Manage Co-Tutors')}}</a></li>
            <li><a href="{{ route('instructor.followings') }}" class="{{ @$navFollowingsActiveClass }}" ><span class="iconify mr-15" data-icon="fluent-mdl2:follow-user"></span>{{__('My Followings')}}</a></li>
            <li><a href="{{ route('instructor.followers') }}" class="{{ @$navFollowersActiveClass }}" ><span class="iconify mr-15" data-icon="fluent-mdl2:user-followed"></span>{{__('My Followers')}}</a></li>
            <li class="menu-has-children current-menu-item {{@$navProfileActiveClass}}">
                <span class="toggle-account-menu">
                    <span class="iconify" data-icon="fontisto:angle-down"></span>
                </span>
                <a href="#" class="{{@$navProfileActiveClass}}"><span class="iconify mr-15" data-icon="bx:bx-user"></span>{{__('Manage Profile')}}</a>
                <ul class="account-sub-menu">
