<style>
    ...
    @else
        ...
        --purple: {{ empty(get_option('language_theme_color')) ? '#704fe6' : get_option('language_theme_color') }};
        --price-toggle-btn: {{ empty(get_option('language_theme_color')) ? '#704fe6' : get_option('language_theme_color') }};
