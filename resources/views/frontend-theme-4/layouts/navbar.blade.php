...
<div class="landing-menu landing-header-learning">
    ...
    <nav class="navbar sticky-header navbar-expand-lg {{ request()->route()->getName() == 'main.index'? 'nav-home': '' }}"
      ...
      <div class="container-fluid p-0"> 
        @if(request()->route()->getName() == 'main.index')
          <a class="navbar-brand ps-3 sf-sticky-logo" href="{{ url('/') }}"><img
              src="{{ getImageFile(get_option('app_black_logo')) }}" alt="Logo"></a>
          @else
          <a class="navbar-brand ps-3 sf-sticky-logo" href="{{ url('/') }}"><img
              src="{{ getImageFile(get_option('app_logo')) }}" alt="Logo"></a>
        @endif
        <a class="navbar-brand ps-3" href="{{ url('/') }}"><img src="{{ getImageFile(get_option('app_logo')) }}"
            alt="Logo">
        </a>
        <button class="navbar-toggler sf-navbar-toggler me-3" type="button" data-bs-toggle="collapse"
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown d-none">
                ...
                <ul class="dropdown-menu {{ $selectedLanguage->rtl == 1 ? 'dropdown-menu-end' : '' }}">
                  ...
                  <li><a class="dropdown-item" href="{{ route($staticMenu->slug) }}">{{ __($staticMenu->name) }}</a>
                  </li>
                  @endforeach
              ...
              <li class="nav-item dropdown menu-round-btn menu-language-btn dropdown-top-space">
                ...
                <ul
                  ...
                  <li><a class="dropdown-item" href="{{ url('/local/' . $app_lang->iso_code) }}">
                      <img src="{{ asset($app_lang->flag) }}" alt="Flag" class="radius-50">{{ $app_lang->language }}</a>
                  </li>
                  @endforeach
                </ul>
              </li>
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0">
                                <div class="user-img-wrap position-relative radius-50">
                                  <img src="{{ asset($student_notification->sender->image_path) }}" alt="img"
                                    class="radius-50">
                                </div>
                              </div>
                        ...
                        <a href="{{ route('notification.url', [$instructor_notification->uuid]) }}"
                          ...
                          <div class="message-user-item-left">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0">
                                <div class="user-img-wrap position-relative radius-50">
                                  <img src="{{ asset(@$instructor_notification->sender->image_path) }}" alt="img"
                                    class="radius-50">
                                </div>
                              </div>
                              <div class="flex-grow-1 {{ $selectedLanguage->rtl == 1 ? 'me-2' : 'ms-2' }}">
              ...
              <li class="nav-item dropdown menu-round-btn menu-user-btn dropdown-top-space">
                ...
                <div
                  class="dropdown-menu-profile dropdown-menu {{ $selectedLanguage->rtl == 1 ? 'dropdown-menu-start' : 'dropdown-menu-end' }}"
                  data-bs-popper="none">
                  ...
                  <ul class="user-dropdown-item-box">
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('student.organization_course') }}"><span
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('subscription_panel') }}"><span class="iconify"
                          data-icon="akar-icons:desktop-device"></span>
                        {{ __('Subscription Panel') }}</a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="{{ route('student.subscription_plan') }}"><span class="iconify"
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('saas_panel') }}"><span class="iconify"
                          data-icon="ic:outline-view-list"></span>
                        {{ __('Buy A Plan') }}</a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="{{ route('saas_plan') }}"><span class="iconify"
                  ...
                  <ul class="user-dropdown-item-box">
                    <li>
                      <a class="dropdown-item" href="{{ route('student.profile') }}"><span class="iconify"
                          data-icon="bytesize:settings"></span>
                        {{ __('Profile Settings') }}</a>
                    </li>
                    @if (@$authUser->role == USER_ROLE_STUDENT && get_option('device_control'))
                    <li>
                      <a class="dropdown-item" href="{{ route('student.all_login_device') }}"><span class="iconify"
                          data-icon="akar-icons:desktop-device"></span>
                        {{ __('Device Control') }}</a>
                    </li>
                    @endif
                    ...
                    (Auth::user()->role == USER_ROLE_ORGANIZATION && @$authUser->organization->status ==
                    STATUS_APPROVED))
                    <li>
                  ...
                  <ul class="user-dropdown-item-box">
                    <li>
                      <a class="dropdown-item" href="{{ route('affiliate.become-an-affiliate') }}"><span class="iconify"
                          data-icon="tabler:affiliate"></span>{{ __('Refer and Earn') }}
                      </a>
                    </li>
                  </ul>
                  @elseif(Auth::user()->is_affiliator == AFFILIATE_REQUEST_PENDING && get_option('referral_status') ==
                  1)
                  <ul class="user-dropdown-item-box">
                    <li>
                  ...
                  @elseif(Auth::user()->is_affiliator == AFFILIATE_REQUEST_REJECTED && get_option('referral_status') ==
                  1)
                  <ul class="user-dropdown-item-box">
                    <li>
                      <a class="dropdown-item" href="#"><span class="iconify"
                  ...
                  <ul class="user-dropdown-item-box">
                    <li>
                      <a class="dropdown-item" href="{{ route('affiliate.dashboard') }}"><span class="iconify"
                          data-icon="tabler:affiliate"></span>
                        {{ __('Affiliate Panel') }}
                      </a>
                    </li>
                  </ul>
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('admin.dashboard') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                          aria-hidden="true" role="img" class="iconify iconify--bxs" width="1em" height="1em"
                          preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" data-icon="bxs:dashboard">
                          <path fill="currentColor"
