                ...
                <div class="price-plan-content">
                    ...
                    <div class="d-flex justify-content-center">
                        <ul class="nav nav-pills zTab-reset zTab-instructorOrganization"
                            id="priceInsOrgpills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-instructor-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-instructor" aria-selected="true">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-organization-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-organization" aria-selected="false">
                    ...
                    <div class="tab-content" id="priceInsOrgpills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-organization" role="tabpanel"
                             aria-labelledby="pills-organization-tab" tabindex="0">
                            <div
                                class="price-plan-tab-wrap d-flex justify-content-center align-items-center g-20 pb-50">
                                <h4 class="fs-18 fw-400 lh-27 text-main-color">{{__('Monthly')}}</h4>
                                <div class="price-toggle-wrap">
